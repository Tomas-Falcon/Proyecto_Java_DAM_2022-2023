public class MetodosDeString {
	public static void main(String arg[]) {
		...
		String SubCadena = StrPalabra.substring(1, 4);// esto lo que hace es mostrar desde la posicion 0 a la anterior a
														// 4
		char LetraPos = StrPalabra.charAt(3);// esto lo que hace es mostrar el caracter en la posicion de 3
		int indice = StrPalabra.indexOf("a", 4);// empieza desde la posicion indicada (4) y te devuelve la posicion del
												// caracter solicitado en relacion a 4
