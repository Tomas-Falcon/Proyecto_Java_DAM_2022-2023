...
public class Profesor{
	...
	/**
	 * Clase main
	 * @param args Array de string, clase main
	 * @see Circulo
	 * @see TrianguloRectangulo
	 * @see Cuadrado
	 * @see Rectangulo
	 * @see Circulo#areaCirculo(double)
	 * @see <a href="https://chat.openai.com/"> the best link in the history </a>
	 */
